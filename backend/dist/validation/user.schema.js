...
const userBaseFields = {
    ...
    image: zod_1.z.string(), // now required
    isApproved: zod_1.z.boolean().optional() // default false in DB
};
// --------------------------------------
// CREATE USER
// --------------------------------------
...
exports.updateUserSchema = zod_1.z.object({
    ...
    body: zod_1.z
        ...
        image: zod_1.z.string().optional(), // optional for update
        isApproved: zod_1.z.boolean().optional() // optional on update
    })
        .strict(),
});
// --------------------------------------
